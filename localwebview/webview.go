...
type WebView interface {
	...
	// Widget returns the native GTK widget pointer (GtkWidget*)
	Widget() unsafe.Pointer

	// BrowserController returns the native browser controller pointer (WebKitWebView*)
...
func (w *webview) BrowserController() unsafe.Pointer {
	return C.webview_get_native_handle(w.w, C.WEBVIEW_NATIVE_HANDLE_KIND_BROWSER_CONTROLLER)
}
